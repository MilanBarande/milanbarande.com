const frWording = {
  ...
  aboutMeText:
    "Développeur front-end et mobile freelance avec plus de 5 ans d'expérience. Je suis sensible aux questions d'UX, de performance, de qualité de code et d'accessibilité. J'apprécie le travail en équipe et la formation de développeurs junior. <br>Je peux travailler en français, anglais ou allemand.",
  resume: 'CV',
  portfolio: 'Portfolio',
...
export default {
  ...
  en: {
    ...
    aboutMe: 'About me',
    aboutMeText:
      'I am a front-end and mobile developer with over 5 years of experience. I care about UX, performances, code quality and accessibility. I enjoy teamwork and training junior developers.<br> I can work in french, english or german.',
    resume: 'CV',
    portfolio: 'Portfolio',
    ...
    cdc: 'Christian Dior Couture',
    timeClubMed1: 'Sep. 2022 - Jan. 2023',
    timeClubMed2: 'Jan. 2023 - <b>Present</b>',
